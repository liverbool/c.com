Ext.define 'Magice.Cloud.view.server.actions.EnableIPv6',
    ...
    bind: title: 'Enable IPv6 - {server.name}'
    locale:
        header: 'Note!'
        description: "You must modify the network settings of your droplet
                      for the new IPv6 address to be functional."
        button:
            action: 'Action'
            tryAgain: 'Try again'
    ...
    listeners: close: 'on.action.enableipv6.close'
